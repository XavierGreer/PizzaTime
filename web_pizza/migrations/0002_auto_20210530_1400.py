# Generated by Django 3.2.3 on 2021-05-30 21:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ('ProductOrderID', models.CharField(default='6FF84', editable=False, max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.AlterField(
            model_name='customer',
            name='customerID',
            field=models.CharField(default='6AD08', editable=False, max_length=100, primary_key=True, serialize=False, verbose_name='Customer ID'),
        ),
        migrations.AlterField(
            model_name='customer',
            name='email',
        ...
        migrations.AlterField(
            model_name='order',
            name='orderID',
            field=models.CharField(default='22404', editable=False, max_length=100, primary_key=True, serialize=False),
        ),
        migrations.AlterField(
            model_name='order',
            name='status',
