# Generated by Django 3.2.3 on 2021-05-31 01:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('customerID', models.CharField(default='BAFBF', editable=False, max_length=100, primary_key=True, serialize=False, verbose_name='Customer ID')),
        ...
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ('ProductOrderID', models.CharField(default='750DB', editable=False, max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('orderID', models.CharField(default='F84FE', editable=False, max_length=100, primary_key=True, serialize=False)),
