# Generated by Django 3.2.3 on 2021-06-12 21:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('customerID', models.CharField(default='C6A66', editable=False, max_length=100, primary_key=True, serialize=False, verbose_name='Customer ID')),
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('orderID', models.CharField(default='44CE4', editable=False, max_length=100, primary_key=True, serialize=False)),
                ...
                ('status', models.CharField(choices=[('Order Received', 'Order Received'), ('Baking', 'Baking'), ('On The Way', 'On The Way'), ('Delivered', 'Delivered')], default='Order Received', max_length=100, verbose_name='Order Status')),
