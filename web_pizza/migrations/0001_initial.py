...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('customerID', models.CharField(default='F1B6E', editable=False, max_length=100, primary_key=True, serialize=False, verbose_name='Customer ID')),
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('orderID', models.CharField(default='9D830', editable=False, max_length=100, primary_key=True, serialize=False)),
