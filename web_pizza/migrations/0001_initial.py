...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('customerID', models.CharField(default='2ABE4', editable=False, max_length=100, primary_key=True, serialize=False, verbose_name='Customer ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ProductOrderID', models.IntegerField(choices=[(12, 'Small'), (14, 'Medium'), (16, 'Large')], default=12)),
