...
def product_list(request, category_slug = None):
    ...
    '''template = loader.get_template('product_list.html')  getting our template
    return HttpResponse(template.render())        rendering the template in HttpResponse'''
...
def product_detail(request, id, slug):
    ...
    return render(request,'pizza_time/templates/detail.html',{'product':product,'cart_product_form':cart_product_form})
