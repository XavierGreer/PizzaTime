...
if ($_POST['Id'] <> '')
{
$dbProdRecords = mysql_query("update customer set Title='$title', FName='$FName', LName='$LName', Addy='$Addy', City='$City', State='$cState', Zip='$cZip', Phone='$phone', Email='$eMail' where Id='$Id'", $dbLocalhost)
